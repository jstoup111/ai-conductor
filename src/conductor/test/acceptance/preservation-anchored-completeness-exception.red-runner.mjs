...
const target = 'test/acceptance/preservation-anchored-completeness-exception.acceptance.test.ts';
const reportPath = join(tmpdir(), `preservation-completeness-red-${process.pid}.json`);
...
try {
  ...
  evidence = {
    ...
    intentRationale:
      'Missing preservation evidence and rubric predicate in the real build_review flow prove #1580 remains unimplemented.',
  };
} catch (error) {
  evidence = {
    executed: 0,
