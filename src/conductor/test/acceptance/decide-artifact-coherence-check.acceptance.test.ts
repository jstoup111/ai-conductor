...
const PLAN = [
  ...
  '**Done when:**',
  '- The outcome staging behavior is implemented.',
  '- The planned outcome behavior is covered by this task.',
  '**Verification:**',
  '',
  ...
  '**Done when:**',
  '- The coherence validation behavior is implemented.',
  '- The planned coherence behavior is covered by this task.',
  '**Verification:**',
  '',
  ...
  it('negative (FR-9): TWO orphan tasks are BOTH reported in one refusal, and a waiver naming both ids lands', async () => {
    ...
    const planWithTwoOrphans = PLAN.replace(
      ...
      [
        ...
        '- src/orphan-one.ts',
        '**Done when:**',
        '- The first orphan task is represented in the fixture.',
        '- The first orphan task reaches coherence validation.',
        '',
        '### Task 4: orphan two',
        ...
        '- src/orphan-two.ts',
        '**Done when:**',
        '- The second orphan task is represented in the fixture.',
        '- The second orphan task reaches coherence validation.',
        '**Verification:**',
        '',
        '## Task Dependency Graph',
      ].join('\n'),
