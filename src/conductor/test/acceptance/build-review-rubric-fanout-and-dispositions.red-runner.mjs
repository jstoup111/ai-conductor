...
const target = 'test/acceptance/build-review-rubric-fanout-and-dispositions.acceptance.test.ts';
const reportPath = join(tmpdir(), `build-review-rubric-red-${process.pid}.json`);
...
try {
  ...
  evidence = {
    ...
    intentRationale:
      'The one-shot grader dispatch and absent build-review operator commands prove independent rubric fan-out and exact-finding disposition are not implemented.',
  };
} catch (error) {
  evidence = {
    executed: 0,
