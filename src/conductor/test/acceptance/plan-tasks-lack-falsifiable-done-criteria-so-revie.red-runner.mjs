...
const target = 'test/acceptance/plan-tasks-lack-falsifiable-done-criteria-so-revie.acceptance.test.ts';
const reportPath = join(tmpdir(), `done-when-plan-red-${process.pid}.json`);
...
try {
  ...
  evidence = {
    ...
    intentRationale:
      'The real landSpec entry point accepting criteria-less tasks proves the land-time Done when gate is not implemented.',
  };
} catch (error) {
  evidence = {
    executed: 0,
