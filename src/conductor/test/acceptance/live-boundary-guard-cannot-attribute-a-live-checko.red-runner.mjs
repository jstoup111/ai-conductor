...
const target = 'test/acceptance/live-boundary-guard-cannot-attribute-a-live-checko.acceptance.test.ts';
const reportPath = join(tmpdir(), `live-boundary-containment-red-${process.pid}.json`);
...
try {
  ...
  evidence = {
    ...
    intentRationale:
      'The real self-host candidate flow remains uncontained and its fail-closed halt lacks containment evidence, proving #1301 is not implemented.',
  };
} catch (error) {
  evidence = {
    executed: 0,
