...
const target =
  'test/acceptance/implementation-drifts-from-local-patterns-and-over.acceptance.test.ts';
const reportPath = join(tmpdir(), `lowest-sufficient-red-${process.pid}.json`);
...
try {
  ...
  evidence = {
    ...
    intentRationale:
      'The acceptance_specs gate still requires a fabricated spec and RED marker instead of honoring a complete lowest-sufficient coverage disposition.',
  };
} catch (error) {
  evidence = {
    executed: 0,
