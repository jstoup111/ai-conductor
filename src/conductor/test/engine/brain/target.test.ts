...
import { resolveTargetRepo, TargetPathMissingError } from '../../../src/engine/brain/target.js';
...
describe('resolveTargetRepo — stale-path negative (Task 7, FR-11)', () => {
  ...
  // resolveTargetRepo silently fell back to cwd, the brain could author a spec
