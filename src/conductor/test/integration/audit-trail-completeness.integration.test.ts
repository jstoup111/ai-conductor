...
> = {
  ...
  build_review_cache_discarded: 'not-audited-by-design',
...
const EVENT_FIXTURES: { [K in ConductorEvent['type']]: Extract<ConductorEvent, { type: K }> } = {
  ...
  build_review_cache_discarded: { type: 'build_review_cache_discarded', rubric: 'scope', lapId: 'lap-1', reason: 'engine-version-mismatch', cachedEngineStamp: 'old-engine', currentEngineStamp: 'new-engine' },
