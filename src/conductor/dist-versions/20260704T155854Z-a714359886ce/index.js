...
async function main() {
  ...
  if (daemonSupervisorCmd) {
    const { dispatchDaemonSupervisor } = await import("./daemon-supervisor-cli-6GIWNL37.js");
...
`);
  ...
  if (daemonCmd) {
    const { runDaemonMode } = await import("./daemon-cli-SPMMNATN.js");
