...
async function main() {
  ...
  if (daemonSupervisorCmd) {
    const { dispatchDaemonSupervisor } = await import("./daemon-supervisor-cli-M3FH4WUH.js");
...
`);
  ...
  if (daemonCmd) {
    const { runDaemonMode } = await import("./daemon-cli-T6DSXBVV.js");
