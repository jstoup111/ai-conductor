...
export const EVENT_SINKS: Record<ConductorEvent['type'], SinkDeclaration> = {
  ...
  feature_usage_total: { render: true, persist: true, audit: false, otel: false },
  ...
  renderer_error: { render: false, persist: true, audit: false, otel: false },
  ...
  test_suite_verification: { render: false, persist: false, audit: false, otel: false },
  ...
  loop_halt: { render: true, persist: true, audit: true, otel: false },
  ...
  rebase_gate_preserved: { render: false, persist: false, audit: false, otel: false },
