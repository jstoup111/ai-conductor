...
export const PRE_DISPATCH_HOOK = [
  ...
  '# Anything else — missing marker, wrong case, missing space, multiple',
  '# markers, trailing prose — blocks the dispatch with exit 2 and an',
  '# instructive error so the caller can fix the prompt and retry.',
