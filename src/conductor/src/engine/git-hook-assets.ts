...
export const COMMIT_MSG_HOOK = [
  ...
  '',
  '  # Report plan-scope containment for task-attributed commits. Scope-check',
  '  # is advisory: an out-of-floor result is reported by scope-check itself,',
  '  # and an unresolvable check records a hook-owned ambiguity before exit 3.',
  '  if [[ -f "$TASK_STATUS_FILE" ]]; then',
  '    rc=0',
