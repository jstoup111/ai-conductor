...
- Preserve cleanly mergeable daemon feature branches at the finish rebase gate while re-kicks still replay the advanced base before retrying the pending gate ({{IMPLEMENTATION_PR}}).
