...
- Ensure every Claude and Codex dispatch, including within-step retries, starts a fresh session while retaining retry context through committed artifacts and the full retry prompt ({{IMPLEMENTATION_PR}}).
