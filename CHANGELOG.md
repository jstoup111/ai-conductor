...
- Stop an in-flight daemon feature after its active serial step or parallel group settles, preserving natural statuses and resuming from the durable boundary after unpark ({{IMPLEMENTATION_PR}}).
