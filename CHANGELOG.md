...
- Keep setup-failure triage from disrupting other worktrees by starting missing Docker containers without stopping, restarting, or tearing down running shared services ({{IMPLEMENTATION_PR}}).
