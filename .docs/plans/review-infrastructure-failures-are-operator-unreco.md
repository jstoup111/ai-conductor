...
### Task rem-fr12-1: src/conductor/src/engine/step-runners.ts:1969-1978 — scope the success override to infrastructureFailure !== undefined && hasJudgedFinding; add a linked-worktree regression in src/conductor/test/engine/build-review-isolation.test.ts proving a fault-free full-coverage judged FAIL remains success=false
