...
3. Implement: retain the resolved inspection and record it once through Task 24's recording seam, exactly as the dispatched, completion, and rebase callers do. No second inspection, and no write inside any predicate path.
4. Verify tests pass (GREEN).
