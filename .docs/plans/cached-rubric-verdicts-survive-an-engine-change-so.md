...
### Task rem-completeness-6: docs/contributing/testing.md:247-248 — remove the stale nested-coordinator ownership guarantee or rewrite it to describe the restored single run-root lifecycle and unconditional teardown removal
