...
`detached, stdio:'ignore'` node spawn) is superseded by the **daemon-supervisor ADR**
(`adr-2026-06-29-daemon-supervisor-port-and-attachable-hosting`) — engineer launch =
