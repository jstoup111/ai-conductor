...
| `adr-2026-08-12-cumulative-build-review-convergence-bound` (APPROVED) | Owns `cumulative`'s value and PASS reset. | Untouched; D4's counter resets on PASS to match. |
