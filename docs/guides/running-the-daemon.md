...
dedup failure. Follow [corrupt intake ledger or stuck ledger lease](../runbooks/daemon-recovery.md#corrupt-intake-ledger-or-stuck-ledger-lease) to inspect the quarantine copy, repair or replace the
ledger, and safely clear an orphaned lease.
