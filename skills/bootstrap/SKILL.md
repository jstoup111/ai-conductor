...
**`.memory/` is set up by the harness, not by this skill.** The configured harness launcher
initializes memory before any bootstrap sub-step runs. This creates a canonical
