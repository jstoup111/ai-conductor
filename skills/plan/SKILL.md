...
```markdown
**Pattern-source:** src/app/source-pattern.ts
**Pattern-source:** `src/app/source-pattern.ts` (source pattern)
**Pattern-source:** [source pattern](../../src/app/source-pattern.ts) — reviewed
