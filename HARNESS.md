...
| build-review-wiring | engine-managed auxiliary rubric | inherits resolved rubric policy | inherits resolved rubric policy | inherits resolved rubric policy | inherits resolved rubric policy | Judges static reachability from changed production surfaces to configured entry points. |
